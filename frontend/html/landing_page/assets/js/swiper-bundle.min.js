                        ...
                        for (var M, P = t.slidesPerColumn, z = T / P, k = Math.floor(h / t.slidesPerColumn), $ = 0; $ < h; $ += 1) {
                            ...
                            if (t.slidesPerColumn > 1) {
                                ...
                                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                                    ...
                                    I = (O = G - (A = Math.floor(G / N)) * N + D * t.slidesPerGroup) + A * T / P, L.css({
                                ...
                                } else "column" === t.slidesPerColumnFill ? (A = $ - (O = Math.floor($ / P)) * P, (O > k || O === k && A === P - 1) && (A += 1) >= P && (A = 0, O += 1)) : O = $ - (A = Math.floor($ / z)) * z;
        ...
        R = {
            update: function(e) {
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var P = h; P <= p; P += 1)(P < b || P > E) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + P + '"]').remove();
                for (var z = 0; z < u.length; z += 1) z >= b && z <= E && (void 0 === p || e ? M.push(z) : (z > p && M.push(z), z < h && C.push(z)));
        ...
        ee = {
            ...
            enable: function() {
                ...
                if (!t.enabled) {
                    ...
                    e.gestures ? (this.$wrapperEl.on("gesturestart", a, t.onGestureStart, i), this.$wrapperEl.on("gesturechange", a, t.onGestureChange, i), this.$wrapperEl.on("gestureend", a, t.onGestureEnd, i)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, a, t.onGestureStart, i), this.$wrapperEl.on(this.touchEvents.move, a, t.onGestureChange, s), this.$wrapperEl.on(this.touchEvents.end, a, t.onGestureEnd, i), this.touchEvents.cancel && this.$wrapperEl.on(this.touchEvents.cancel, a, t.onGestureEnd, i)), this.$wrapperEl.on(this.touchEvents.move, "." + this.params.zoom.containerClass, t.onTouchMove, s)
                }
            },
            disable: function() {
                var e = this.zoom;
